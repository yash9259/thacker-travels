        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                  <h3 className="font-display font-bold text-lg leading-tight text-[#d2562d]">Thacker</h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <a
                  href="https://www.google.com/maps/search/?api=1&query=Shop%20No.%203%2C%20Memon%20Musafir%20Khana%2C%20Station%20Road%2C%20Bhuj%2C%20Gujarat%20370001"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-start gap-3 text-primary-foreground/70 hover:text-terracotta-light transition-colors"
                >
