  ...
  return (
    <div className="min-h-screen">
      <Seo
        ...
        keywords="Bhuj taxi services, Taxi booking Bhuj, Cab service in Bhuj, One-way cab Bhuj, Round trip taxi Bhuj, Airport pick up Bhuj, Airport transfer Kutch, Kutch tour operator, Kutch sightseeing tour, Kutch desert tours, White Rann tours from Bhuj, Rann of Kutch tour packages, Rann Utsav taxi booking, Mandvi Beach tours, Dholavira heritage tour, Gujarat sightseeing tours, Local tours Kutch, Bhuj tourism services, Bhuj travel service provider, Taxi and tour combo packages, Car rental Bhuj, car rental in bhuj kutchh, car on rent bhuj, car hire bhuj, self drive car rental bhuj, taxi service near me, car rental near me"
        path="/services"
        image="/image.webp"
